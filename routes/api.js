...
loghandler = {
    notparam: {
        ...
        getApikey: 'Contact Me On WhatsApp For Apikey'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    nottext2: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Input text2 parameters'
    },
    notnabi: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'Enter prophet parameter'
    },
    nottext3: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'Input text3 parameters'
    },
    nottheme: {
        status: false,
        creator: `${creator}`,
    ...
    notvalue: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Input parameter values'
    },
    notheme: {
    	status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'Contact Me On WhatsApp For Apikey'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
    ...
    invalidkata: {
        status: false,
        creator: `${creator}`,
        message: 'Error, maybe the word is not in the api.'
    },
    notAddApiKey: {
        status: false,
        creator: `${creator}`,
        code: 406,
        message: 'Input status parameter, apikeyInput, email, phone number, name, age, country, exp'
    },
    error: {
        status: false,
        creator: `${creator}`,
        message: 'maybe its being repaired'
    }
}

const listkey = ["Jarvis", "sparrow"];
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'jarvis') return res.json(loghandler.invalidKey)
...
router.get('/cewe/vietnam', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'jarvis')  return res.json(loghandler.invalidKey)
